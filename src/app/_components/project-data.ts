...
/** All featured projects in data order — horizontal gallery uses one full slide per entry. */
...
/** First featured project in list order, or null — matches default “selected” in works when filters are cleared. */
export function getDefaultFeaturedProject(): Project | null {
